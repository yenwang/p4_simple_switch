...
### key point for generating arp packet or not, /24 specify different subnet and if host are in different subnet then no arp packet is generated( insteaddst mac as switch interface)
	    ...
	    sw_mac = '00:00:%02x:%02x:%02x:%02x' % (host_num, host_num, host_num, host_num)
